...
Re-verified the plan's four specific levers (numbered independently
from `docs/decisions.md`'s ruling text) with live
...
3. **Schema-context caching — technically available via undocumented
   ...
   empirical probe against the default LLM model proved it IS
