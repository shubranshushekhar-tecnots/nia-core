...
- **Phase 6 BLOCK-0 PREREQUISITE**: explicit source entity/table
  selection. Source nodes persist no entity selection today
  ...
  `PHASE5_SESSION_NOTES.md`'s Session 5 entry and `PHASE5_EXIT.md`'s open
  risks for the full writeup.
